...
[1] = LAYOUT_ansi_84(
	...
	_______,				_______,   	_______,   	RGB_TEST,  	_______,    _______,   	MO(5),	MO(4), 		QK_UNDERGLOW_SPEED_DOWN,	QK_UNDERGLOW_SPEED_UP,	_______,	_______,	            QK_UNDERGLOW_VALUE_UP,    _______,
	_______,	_______,	_______,										_______, 							_______,	MO(1),   	_______,				QK_UNDERGLOW_MODE_NEXT,	QK_UNDERGLOW_VALUE_DOWN,    QK_UNDERGLOW_HUE_UP),
...
[3] = LAYOUT_ansi_84(
	...
	TOG_CAPS_IND,	SLEEP_TIMEOUT_DEC,   	SLEEP_TIMEOUT_SHOW,   	SLEEP_TIMEOUT_INC,  	_______,   	_______,   	DEBOUNCE_RELEASE_DEC,	DEBOUNCE_RELEASE_SHOW,   	DEBOUNCE_RELEASE_INC,   	_______,  	_______,	_______, 	_______,                            _______,
	_______,				_______,   	_______,   	RGB_TEST,  	_______,    _______,   	MO(5),	MO(4), 		QK_UNDERGLOW_SPEED_DOWN,	QK_UNDERGLOW_SPEED_UP,	_______,	_______,	            QK_UNDERGLOW_VALUE_UP,    _______,
	_______,	_______,	_______,										_______, 							_______,	MO(3),		_______,				QK_UNDERGLOW_MODE_NEXT,    QK_UNDERGLOW_VALUE_DOWN,	QK_UNDERGLOW_HUE_UP),
...
[5] = LAYOUT_ansi_84(
	...
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 				_______,	_______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,	_______, 	 						_______,	_______,
	_______,				_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______, 	RIGHT_SIDE_SPD,	RIGHT_SIDE_SPI,	_______,	_______,	            RIGHT_SIDE_VAI,   _______,
	_______,	_______,	_______,										_______, 							_______,	MO(5),   	_______,				RIGHT_SIDE_MOD,	RIGHT_SIDE_VAD,   RIGHT_SIDE_HUI),
