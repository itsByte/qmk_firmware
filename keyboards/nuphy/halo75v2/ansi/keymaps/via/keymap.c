...
[1] = LAYOUT_ansi_84(
	...
	_______,				_______,   	_______,   	RGB_TEST,  	_______,    _______,   	_______,	MO(4), 		QK_UNDERGLOW_SPEED_DOWN,	QK_UNDERGLOW_SPEED_UP,	_______,	_______,	            QK_UNDERGLOW_VALUE_UP,    _______,
	_______,	_______,	_______,										_______, 							            _______,	MO(1),		            QK_UNDERGLOW_MODE_NEXT,    QK_UNDERGLOW_VALUE_DOWN,	QK_UNDERGLOW_HUE_UP),
// layer win
[2] = LAYOUT_ansi_84(
...
[3] = LAYOUT_ansi_84(
	...
	TOG_CAPS_IND,	SLEEP_TIMEOUT_DEC,   	SLEEP_TIMEOUT_SHOW,   	SLEEP_TIMEOUT_INC,  	_______,   	_______,   	DEBOUNCE_RELEASE_DEC,	DEBOUNCE_RELEASE_SHOW,   	DEBOUNCE_RELEASE_INC,   	_______,  	_______,	_______, 	_______,                            _______,
	_______,				_______,   	_______,   	RGB_TEST,  	_______,    _______,   	_______,	MO(4), 		QK_UNDERGLOW_SPEED_DOWN,	QK_UNDERGLOW_SPEED_UP,	_______,	_______,	            QK_UNDERGLOW_VALUE_UP,    _______,
	_______,	_______,	_______,										_______, 							            _______,	MO(3),					QK_UNDERGLOW_MODE_NEXT,    QK_UNDERGLOW_VALUE_DOWN,	QK_UNDERGLOW_HUE_UP),
// layer 4
[4] = LAYOUT_ansi_84(
