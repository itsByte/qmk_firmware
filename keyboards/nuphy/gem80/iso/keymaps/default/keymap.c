...
[1] = LAYOUT_tkl_f13_iso(
	...
	_______,	_______,	_______,   	_______,   	_______,  	_______,    _______,   	MO(5),		MO(4), 		QK_UNDERGLOW_SPEED_DOWN,	QK_UNDERGLOW_SPEED_UP,	_______,				_______,				QK_UNDERGLOW_VALUE_UP,
	_______,	_______,	_______,										_______, 							_______,	_______,   	MO(1),		_______,				QK_UNDERGLOW_MODE_NEXT,    QK_UNDERGLOW_VALUE_DOWN,	QK_UNDERGLOW_HUE_UP),
#else
[1] = LAYOUT_tkl_f13_iso(
	_______, 	KC_F1,  	KC_F2,  	KC_F3, 		KC_F4,  	KC_F5,  	KC_F6,  	KC_F7,  	KC_F8,  	KC_F9, 		KC_F10, 	KC_F11, 	KC_F12, 	KC_F13,	    _______,	MAC_PRT,	_______,
...
[3] = LAYOUT_tkl_f13_iso(
	...
	TOG_CAPS_IND,	SLEEP_TIMEOUT_DEC,   	SLEEP_TIMEOUT_SHOW,   	SLEEP_TIMEOUT_INC,  	_______,   	_______,   	_______,	_______,   	_______,   	_______,  	_______,	_______, 	BAT_SHOW,	_______,
	_______,	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	MO(5),		MO(4), 		QK_UNDERGLOW_SPEED_DOWN,	QK_UNDERGLOW_SPEED_UP,	_______,				_______,				QK_UNDERGLOW_VALUE_UP,
	_______,	_______,	_______,										_______, 							_______,	_______,   	MO(3),		_______,				QK_UNDERGLOW_MODE_NEXT,    QK_UNDERGLOW_VALUE_DOWN,	QK_UNDERGLOW_HUE_UP),
#else
[3] = LAYOUT_tkl_f13_iso(
